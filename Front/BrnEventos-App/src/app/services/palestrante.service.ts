...
export class PalestranteService {
  ...
  public getPalestrantes(page?: number,
                         itemsPerPage?: number,
                         term?: string): Observable<PaginatedResult<Palestrante[] | null>> {
    const paginatedResult: PaginatedResult<Palestrante[] | null> = new
                           PaginatedResult<Palestrante[] | null>();
